...
class StarTrekService {
  ...
  static List<Episode> _generateTOSS1Episodes() {
    return [
      Episode(id: 'tos_s1_e1', title: 'The Man Trap', seasonNumber: 1, episodeNumber: 1),
      Episode(id: 'tos_s1_e2', title: 'Charlie X', seasonNumber: 1, episodeNumber: 2),
      Episode(id: 'tos_s1_e3', title: 'Where No Man Has Gone Before', seasonNumber: 1, episodeNumber: 3),
  ...
  static List<Episode> _generateTOSS2Episodes() {
    return [
      Episode(id: 'tos_s2_e1', title: 'Amok Time', seasonNumber: 2, episodeNumber: 1),
      Episode(id: 'tos_s2_e2', title: 'Who Mourns for Adonais?', seasonNumber: 2, episodeNumber: 2),
      // Add more episodes as needed
    ];
  }
  ...
  static List<Episode> _generateTOSS3Episodes() {
    return [
      Episode(id: 'tos_s3_e1', title: 'Spock\'s Brain', seasonNumber: 3, episodeNumber: 1),
      Episode(id: 'tos_s3_e2', title: 'The Enterprise Incident', seasonNumber: 3, episodeNumber: 2),
      // Add more episodes as needed
    ];
  }
  ...
  static List<Episode> _generateEnterpriseS1Episodes() => [
    Episode(id: 'ent_s1_e1', title: 'Broken Bow', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateEnterpriseS2Episodes() => [
    Episode(id: 'ent_s2_e1', title: 'Shockwave, Part II', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateEnterpriseS3Episodes() => [
    Episode(id: 'ent_s3_e1', title: 'The Xindi', seasonNumber: 3, episodeNumber: 1),
  ];
  
  static List<Episode> _generateEnterpriseS4Episodes() => [
    Episode(id: 'ent_s4_e1', title: 'Storm Front', seasonNumber: 4, episodeNumber: 1),
  ];

  static List<Episode> _generateTNGS1Episodes() => [
    Episode(id: 'tng_s1_e1', title: 'Encounter at Farpoint', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS2Episodes() => [
    Episode(id: 'tng_s2_e1', title: 'The Child', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS3Episodes() => [
    Episode(id: 'tng_s3_e1', title: 'Evolution', seasonNumber: 3, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS4Episodes() => [
    Episode(id: 'tng_s4_e1', title: 'The Best of Both Worlds, Part II', seasonNumber: 4, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS5Episodes() => [
    Episode(id: 'tng_s5_e1', title: 'Redemption II', seasonNumber: 5, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS6Episodes() => [
    Episode(id: 'tng_s6_e1', title: 'Time\'s Arrow, Part II', seasonNumber: 6, episodeNumber: 1),
  ];
  
  static List<Episode> _generateTNGS7Episodes() => [
    Episode(id: 'tng_s7_e1', title: 'Descent, Part II', seasonNumber: 7, episodeNumber: 1),
  ];

  static List<Episode> _generateDS9S1Episodes() => [
    Episode(id: 'ds9_s1_e1', title: 'Emissary', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S2Episodes() => [
    Episode(id: 'ds9_s2_e1', title: 'The Homecoming', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S3Episodes() => [
    Episode(id: 'ds9_s3_e1', title: 'The Search, Part I', seasonNumber: 3, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S4Episodes() => [
    Episode(id: 'ds9_s4_e1', title: 'The Way of the Warrior', seasonNumber: 4, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S5Episodes() => [
    Episode(id: 'ds9_s5_e1', title: 'Apocalypse Rising', seasonNumber: 5, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S6Episodes() => [
    Episode(id: 'ds9_s6_e1', title: 'A Time to Stand', seasonNumber: 6, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDS9S7Episodes() => [
    Episode(id: 'ds9_s7_e1', title: 'Image in the Sand', seasonNumber: 7, episodeNumber: 1),
  ];

  static List<Episode> _generateVoyagerS1Episodes() => [
    Episode(id: 'voy_s1_e1', title: 'Caretaker', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateVoyagerS2Episodes() => [
    Episode(id: 'voy_s2_e1', title: 'The 37\'s', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateVoyagerS3Episodes() => [
    Episode(id: 'voy_s3_e1', title: 'Basics, Part II', seasonNumber: 3, episodeNumber: 1),
  ];
  
  static List<Episode> _generateVoyagerS4Episodes() => [
    Episode(id: 'voy_s4_e1', title: 'Scorpion, Part II', seasonNumber: 4, episodeNumber: 1),
  ];
  ...
  static List<Episode> _generateVoyagerS6Episodes() => [
    Episode(id: 'voy_s6_e1', title: 'Equinox, Part II', seasonNumber: 6, episodeNumber: 1),
  ];
  
  static List<Episode> _generateVoyagerS7Episodes() => [
    Episode(id: 'voy_s7_e1', title: 'Unimatrix Zero, Part II', seasonNumber: 7, episodeNumber: 1),
  ];

  static List<Episode> _generateDiscoveryS1Episodes() => [
    Episode(id: 'dis_s1_e1', title: 'The Vulcan Hello', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDiscoveryS2Episodes() => [
    Episode(id: 'dis_s2_e1', title: 'Brother', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDiscoveryS3Episodes() => [
    Episode(id: 'dis_s3_e1', title: 'That Hope Is You, Part 1', seasonNumber: 3, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDiscoveryS4Episodes() => [
    Episode(id: 'dis_s4_e1', title: 'Kobayashi Maru', seasonNumber: 4, episodeNumber: 1),
  ];
  
  static List<Episode> _generateDiscoveryS5Episodes() => [
    Episode(id: 'dis_s5_e1', title: 'Red Directive', seasonNumber: 5, episodeNumber: 1),
  ];

  static List<Episode> _generateSNWS1Episodes() => [
    Episode(id: 'snw_s1_e1', title: 'Strange New Worlds', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateSNWS2Episodes() => [
    Episode(id: 'snw_s2_e1', title: 'The Broken Circle', seasonNumber: 2, episodeNumber: 1),
  ];

  static List<Episode> _generateLowerDecksS1Episodes() => [
    Episode(id: 'ld_s1_e1', title: 'Second Contact', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateLowerDecksS2Episodes() => [
    Episode(id: 'ld_s2_e1', title: 'Strange Energies', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generateLowerDecksS3Episodes() => [
    Episode(id: 'ld_s3_e1', title: 'Grounded', seasonNumber: 3, episodeNumber: 1),
  ];
  ...
  static List<Episode> _generateProdigyS1Episodes() => [
    Episode(id: 'pro_s1_e1', title: 'Lost and Found', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generateProdigyS2Episodes() => [
    Episode(id: 'pro_s2_e1', title: 'Into the Breach, Part I', seasonNumber: 2, episodeNumber: 1),
  ];

  static List<Episode> _generatePicardS1Episodes() => [
    Episode(id: 'pic_s1_e1', title: 'Remembrance', seasonNumber: 1, episodeNumber: 1),
  ];
  
  static List<Episode> _generatePicardS2Episodes() => [
    Episode(id: 'pic_s2_e1', title: 'The Star Gazer', seasonNumber: 2, episodeNumber: 1),
  ];
  
  static List<Episode> _generatePicardS3Episodes() => [
    Episode(id: 'pic_s3_e1', title: 'The Next Generation', seasonNumber: 3, episodeNumber: 1),
  ];
}